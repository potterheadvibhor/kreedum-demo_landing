      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            style={{ borderColor: scrolled ? "rgba(14,26,61,0.2)" : "rgba(255,255,255,0.3)", color: scrolled ? C.navy : C.white }}
          >
            Get a Quote
          </a>
          <button
...
function Products() {
  ...
  return (
    <section id="products" className="py-16 md:py-24 lg:py-32" style={{ backgroundColor: C.paper }}>
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="max-w-xl mb-10 md:mb-14">
          <div className="font-mono text-xs tracking-widest uppercase mb-3 md:mb-4" style={{ color: C.blue }}>
            What We Stock
          </div>
          <h2 className="font-display font-bold text-2xl sm:text-3xl md:text-4xl" style={{ color: C.navy }}>
...
/*
 * Placeholder photos for the Infrastructure section slider — same
 * "swap for real project photography" status as CATEGORY_PHOTOS above.
 */
const INFRA_PHOTOS = [
  { src: "https://images.unsplash.com/photo-1728486145245-d4cb0c9c3470?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", alt: "Ground equipment on a sports field" },
        ...
        <div className="order-2 md:order-1">
          <div className="overflow-hidden rounded-2xl relative">
            ...
            <button
              ...
              style={{ backgroundColor: "rgba(14,26,61,0.55)", color: C.white }}
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {INFRA_PHOTOS.map((p, i) => (
              <button
                ...
                style={{
                  ...
                  height: "8px",
                  backgroundColor: i === index ? C.blue : "rgba(255,255,255,0.25)",
                }}
              />
            ))}
          </div>
...
function Locations() {
  const stores = [
    {
      name: "Sports Line",
      tag: "Sports Goods · Footwear · Apparel",
    ...
    {
      name: "Kreedum",
      tag: " Gym Machines · Fitness accesories · Sports Infrastructure",
